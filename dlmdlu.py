...
parser.add_argument('-n', action='store',dest='name', help='name of movie' ,type=str,required='true')
parser.add_argument('-k', action='store',dest='kind', help='movie / series' ,type=str,default='movie')
parser.add_argument('-q', action='store',dest='quality', help='quality (480/720/1080)' ,type=str,default='')
